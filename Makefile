...
SRC = process_generator.c clk.c scheduler.c process.c test_generator.c
...
scheduler.out: scheduler.o DS/Msgq.o DS/PQueue.o
	gcc $(CFLAGS) $^ -o $@ -lm
...
clean:
	rm -f *.out *.o DS/*.o processes.txt scheduler.log scheduler.perf
